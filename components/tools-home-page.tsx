...
import { ExternalLink, Search, Sparkles, Newspaper, Coins, Wallet, TrendingUp, Globe, Zap, Settings, ArrowRight, BarChart3, Dog, Building2 } from "lucide-react";
...
export function ToolsHomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50 dark:from-slate-950 dark:via-blue-950/20 dark:to-indigo-950/30 relative overflow-hidden">
      {/* Background Pattern */}
          ...
          {categories.map((category) => {
            ...
            return (
              <button
                ...
                className={`group relative flex items-center gap-3 rounded-xl border-2 px-4 py-3 text-left transition-all duration-200 cursor-pointer ${
                  isSelected
        ...
        <div className="mx-auto max-w-7xl px-6 py-8">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            <div className="flex items-center gap-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-black to-gray-900 dark:from-white dark:to-gray-100">
                <span className="text-sm font-bold text-white dark:text-black">X</span>
              </div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">
                © 2024 X Monitor. 区块链工具导航平台.
              </p>
            </div>
            <Link href="/dashboard">
